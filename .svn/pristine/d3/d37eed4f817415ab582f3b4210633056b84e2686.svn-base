...
public class ConfigurationManagementController {
    ...
    public DashboardCountRes getDashboardCount(@RequestBody BaseReq req,
        ...
        Long allAgencyCount = agencyRepository.countByIsActiveAndIsAlive(Boolean.TRUE, Boolean.TRUE);
        Long registeredAgencyCount = agencyRepository.countByIsActiveAndIsAliveAndAgencyState(Boolean.TRUE, Boolean.TRUE, AgencyStateEnm.REGISTERED);
        Long confirmedAgencyCount = agencyRepository.countByIsActiveAndIsAliveAndAgencyState(Boolean.TRUE, Boolean.TRUE, AgencyStateEnm.CONFIRMED);
        Long rejectedAgencyCount = agencyRepository.countByIsActiveAndIsAliveAndAgencyState(Boolean.TRUE, Boolean.TRUE, AgencyStateEnm.REJECTED);
        ...
        res.setAllAgency(allAgencyCount.toString());
        res.setRegisteredAgency(registeredAgencyCount.toString());
        res.setConfirmedAgency(confirmedAgencyCount.toString());
        res.setRejectedAgency(rejectedAgencyCount.toString());
